                    ...
                    {!forCommunity && (
                        <div
                            ...
                            <div className="flex flex-col items-end w-32 text-sm">
                                <ul className={`text-xs ${menuOpen ? 'block' : 'hidden'} overflow-hidden right-0 peer-focus:block hover:block w-40 bg-black/50 rounded-lg shadow-md mt-2 py-1 z-10`}>
                ...
                <div className="p-4">
                    ...
                    {!forCommunity && (
                        <div className="mt-4 grid grid-cols-2 gap-3">
                            ...
                            <PrimaryButton className="rounded-md" onClick={() => togglePublish(gen.id)}>{gen.isPublished ? 'Unpublish' : 'Publish'}</PrimaryButton>
                </div>
                    )}
